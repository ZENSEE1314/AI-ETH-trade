...
export const CURRICULUM: Module[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { topic: 'EMA 200 confirmation (1H → 1M)', summary: 'Only take the post-sweep entry when it is not fighting the EMA 200: read the line on the 1H (trend) down to the 1M (entry) and require the same side (or a fresh reclaim) on both. Keeps you with the higher-timeframe flow after the grab.', appliedIn: 'strategy/ema.ts readEma/emaSupports; signal.ts EMA stage' },
